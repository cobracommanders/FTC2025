...
@Autonomous(name = "Shoot close to wall", group = "Robot")
public class Shootclosetowall extends LinearOpMode {
...
////        this.shooter.feedReverse();
            ...
            this.drivetrain.driveToPosition(24, 0.5);
